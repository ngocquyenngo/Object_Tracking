...
objth=0.5 #threshold object
confth=0.5 #threshold confidence
nmsth=0.5 #threshold MNS
inwidth=320
inheight=320
    ...
    if ret==True:
        if (count%30==0 or tflag==0) and fdflag!=1:
            ...
            if rett==True:
                ...
                cv2.putText(frame, "FPS : " + str(int(fps)), (20,50),
                            cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255,0,0), 2)
                # cv2.putText(frame,(pt1[0]-5,pt1[1]-5),cv2.FONT_HERSHEY_COMPLEX,0.65,(255,255,0),2)
